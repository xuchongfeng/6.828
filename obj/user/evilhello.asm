...
sys_env_destroy(envid_t envid)
{
  ...
  800119:	68 2a 0f 80 00       	push   $0x800f2a
  80011e:	6a 23                	push   $0x23
  800120:	68 47 0f 80 00       	push   $0x800f47
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80019a:	68 2a 0f 80 00       	push   $0x800f2a
  80019f:	6a 23                	push   $0x23
  8001a1:	68 47 0f 80 00       	push   $0x800f47
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001dc:	68 2a 0f 80 00       	push   $0x800f2a
  8001e1:	6a 23                	push   $0x23
  8001e3:	68 47 0f 80 00       	push   $0x800f47
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021e:	68 2a 0f 80 00       	push   $0x800f2a
  800223:	6a 23                	push   $0x23
  800225:	68 47 0f 80 00       	push   $0x800f47
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800260:	68 2a 0f 80 00       	push   $0x800f2a
  800265:	6a 23                	push   $0x23
  800267:	68 47 0f 80 00       	push   $0x800f47
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002a2:	68 2a 0f 80 00       	push   $0x800f2a
  8002a7:	6a 23                	push   $0x23
  8002a9:	68 47 0f 80 00       	push   $0x800f47
...
sys_ipc_recv(void *dstva)
{
  ...
  800306:	68 2a 0f 80 00       	push   $0x800f2a
  80030b:	6a 23                	push   $0x23
  80030d:	68 47 0f 80 00       	push   $0x800f47
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800334:	56                   	push   %esi
  800335:	50                   	push   %eax
  800336:	68 58 0f 80 00       	push   $0x800f58
  ...
  800347:	e8 57 00 00 00       	call   8003a3 <vcprintf>
	cprintf("\n");
  80034c:	c7 04 24 7c 0f 80 00 	movl   $0x800f7c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80049b:	0f be 80 7e 0f 80 00 	movsbl 0x800f7e(%eax),%eax
  8004a2:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80060e:	50                   	push   %eax
  80060f:	68 9f 0f 80 00       	push   $0x800f9f
  800614:	53                   	push   %ebx
  800615:	56                   	push   %esi
  ...
  800628:	eb d2                	jmp    8005fc <vprintfmt+0x10e>
			...
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
  80062a:	52                   	push   %edx
  80062b:	68 96 0f 80 00       	push   $0x800f96
  800630:	53                   	push   %ebx
  800631:	56                   	push   %esi
  ...
  80066a:	eb 75                	jmp    8006e1 <vprintfmt+0x1f3>
		...
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
				p = "(null)";
  80066c:	bf 8f 0f 80 00       	mov    $0x800f8f,%edi
