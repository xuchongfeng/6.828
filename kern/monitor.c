...
static struct Command commands[] = {
	...
	{ "backtrace", "Display information about call stack", mon_backtrace },
	{ "showmappings", "Display the corresponding physical address of virtual address", mon_showmappings},
};
